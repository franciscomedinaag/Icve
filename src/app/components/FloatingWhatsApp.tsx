...
export function FloatingWhatsApp() {
  ...
  const handleClick = () => {
    window.open('https://wa.me/523329544065?text=Hola,%20me%20interesa%20obtener%20información%20sobre%20la%20instalación%20de%20cargadores%20para%20vehículos%20eléctricos', '_blank');
  };
              ...
              >
                <div className="bg-white rounded-2xl shadow-2xl p-4 relative">
                  ...
                  <p className="text-sm text-gray-800 pr-6">
                    ¿Necesitas ayuda? <span className="font-semibold">Chatea con nosotros</span> por WhatsApp
                  </p>
                  {/* Arrow */}
